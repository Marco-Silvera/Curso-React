  ...
  return (
    <div className='main-container'>
      ...
      <section className='App-container'>
        <img className='App-img' src="machu-picchu.webp" alt="Machu Picchu Maravilla del mundo" />
      ...
      <section className="image-container">
        <img src="amazonas-bote.webp" alt="Amazonas en bote" className="darkened-image" />
      ...
      <section className='Aternatives'>
        ...
        <section className='Aternatives-container'>
          <article className='Aternatives-item'>
            <a href="">
              <img src="circuito-1.webp" alt="Aternativa1" />
              <div className='Circuits-overlay'>
                <h3 className='Circuits-overlay-title'>
                  Alternativa1
                </h3>
      ...
      <section className='Testimony-container'>
        <img className='Testimony-img' src="fondo-testimonio.webp" alt="Machu Picchu Maravilla del mundo" />
